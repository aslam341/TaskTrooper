...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('core', '0009_rename_invite_link_project_invite_code'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_profiles', to='core.project')),
